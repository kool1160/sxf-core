  ...
  def change do
    ...
    create table(:tasks, primary_key: false) do
      ...
      add :repository_registration_id,
          references(:repository_registrations, type: :binary_id, on_delete: :restrict),
          null: false
    ...
    create table(:evidence_references, primary_key: false) do
      add :id, :binary_id, primary_key: true
      add :task_id, references(:tasks, type: :binary_id, on_delete: :restrict), null: false
      add :attempt_id, references(:task_attempts, type: :binary_id, on_delete: :restrict)
    ...
    create table(:blockers, primary_key: false) do
      ...
      add :resolution_human_decision_id, :binary_id
    ...
    create table(:event_evidence_references, primary_key: false) do
      add :transition_event_id,
          references(:task_transition_events, type: :binary_id, on_delete: :delete_all),
          primary_key: true
